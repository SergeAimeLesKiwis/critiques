<div class="modal-header light-blue darken-3 white-text">
	<input type="hidden" id="modal-item" value="<?php echo $item->id; ?>" />
...
<div class="modal-body mb-0">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-7">
				<h4 class="card-title">
					<b class="link-card"><?php echo $item->getClassification(); ?></b>
					<small id="grades" class="pull-right col-md-4" role="button">
						<?php $this->load->view('item/_grades', array('grades' => $item->grades)); ?>
					</small>
				</h4>
